...
| Agent Catalog | [agent-catalog.md](agent-catalog.md) | proposed | implement only stable definitions, immutable versions, deployment pointer, trigger resolution, and Run pinning |
