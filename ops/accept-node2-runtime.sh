...
[[ "$database_state" == "28|sql/0028_remote_a2a.sql|520|624|3224|520" ]] || {
...
echo "node2_database=28|sql/0028_remote_a2a.sql|520|624|3224|520"
echo "node2_release=akashic-node2-20260719"
